<a href="{{ route('password.new', ['_token' => $item->_token]) }}">Zmień hasło</a>
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#555555;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:20px;padding-right:40px;padding-bottom:15px;padding-left:40px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 46px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 55px; margin: 0;"><span style="font-size: 46px; color: #003188;"><strong>Próba zmiany hasła do konta</strong></span></p>
                                            <p style="line-height: 1.2; text-align: center;">
                                                Jeśli chcesz zmienić hasło do swojego konta <a href="{{ route('password.new', ['_token' => $item->_token]) }}">kliknij tutaj</a>
                                                Jeśli to nie Ty podjąłeś próbę zmiany hasła zignoruj tą wiadomość i dla bezpieczeństwa zmień hasło w panelu swojego konta.
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
